...
public class DepartmentController {
    ...
    @ApiResponses(value = {})
    @PostMapping(ROLE_ADMIN + "/v1/department")
    ...
    @PutMapping(ROLE_ADMIN + "/v1/department/{id}")
    ...
    @DeleteMapping(ROLE_ADMIN + "/v1/department/{id}")
    ...
    @GetMapping({
        ROLE_ADMIN + "/v1/department/{id}",
        ROLE_EMP + "/v1/department/{id}",
        ROLE_LEAD + "/v1/department/{id}",
        ROLE_EMP + "/v1/department/{id}"})
    ...
    @GetMapping({
        ROLE_ADMIN + "/v1/department/all",
        ROLE_EMP + "/v1/department/all",
        ROLE_LEAD + "/v1/department/all",
        ROLE_EMP + "/v1/department/all"})
