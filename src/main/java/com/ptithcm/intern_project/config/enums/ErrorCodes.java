...
public enum ErrorCodes {
    ...
    TASK_HASNT_STARTED(14005, "Task has not started yet, action denied", BAD_REQUEST),
    CANNOT_DONE_TASK(14006, "Approve all Reports before completing Task!", BAD_REQUEST),
    EXISTS_APPROVED_REPORT_ON_TASK(14007, "Existing Approved Report on Task, action denied", BAD_REQUEST),
    TASK_CREATED_IN_LENGTHY_TIME(14008, "Task has been created in a lengthy time, action denied", BAD_REQUEST),
    ...
    UPDATE_START_DATE_ON_STARTED_TASK(14015, "Cannot update Start Date, because it's the past (Task started)!", BAD_REQUEST),
    CANNOT_UPDATE_STARTED_TASK(14016, "Cannot update Start Date, because it's the past (Task started)!", BAD_REQUEST),
    EXISTS_REPORT_ON_TASK(14017, "Existing Report on Task, action denied", BAD_REQUEST),
    //--Report(15)
    REPORT_REVIEWED(15000, "Report has been reviewed, action denied", BAD_REQUEST),
    //--Project(16)
    PROJECT_WAS_CLOSED(16000, "Project was closed, action denied", BAD_REQUEST),
    ...
    PROJECT_IS_NOT_IN_PROGRESS(16004, "Project is not in progress, action denied", BAD_REQUEST),
    ...
    //--Phase(17)
    CANT_DELETE_PHASE(17000, "Phase has already had Collection, action denied", BAD_REQUEST),
